            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/managers/add') }}">
                            {{ csrf_field() }}
                            ...
                            Note: Manager's default password is 'abcd1234'. Each manager account will be promped for a
