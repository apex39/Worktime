        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/managers/edit/'.$user->id) }}">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-md-6">
                          <select class="selectpicker form-control" id="shops" name="shops[]" required multiple>
