        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                @include('flash::message')
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/workers/add/'.$worker_id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="worker_id" type="text" class="form-control" name="name" value="{{ $worker_id }}" disabled>
